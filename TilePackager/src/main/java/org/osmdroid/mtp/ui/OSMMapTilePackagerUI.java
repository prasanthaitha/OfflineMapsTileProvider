               ...
               public void actionPerformed(final ActionEvent e) {
                    ...
                    if (dialogButton == JOptionPane.YES_OPTION) {
                         new Thread(new Runnable() {
                              @Override
                              public void run() {
                                   OSMMapTilePackager.execute(url, "true", destination, temp, threads, appendix, minzoom, maxzoom, north, south, east, west, new OSMMapTilePackager.ProgressNotification() {
                                        @Override
